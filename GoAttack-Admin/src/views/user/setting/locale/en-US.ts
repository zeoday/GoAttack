export default {
  ...
  'userSetting.changePassword.oldPassword': 'Old Password',
  'userSetting.changePassword.newPassword': 'New Password',
  'userSetting.changePassword.confirmPassword': 'Confirm New Password',
  'userSetting.changePassword.placeholder.oldPassword': 'Please enter old password',
  'userSetting.changePassword.placeholder.newPassword': 'Please enter new password, at least 6 characters',
  'userSetting.changePassword.placeholder.confirmPassword': 'Please enter new password again',
  'userSetting.changePassword.error.oldPassword': 'Old password is required',
  'userSetting.changePassword.error.newPassword': 'New password is required',
  'userSetting.changePassword.error.passwordLength': 'Password must be at least 6 characters',
  'userSetting.changePassword.error.confirmPassword': 'Confirm new password is required',
  'userSetting.changePassword.error.notMatch': 'Passwords do not match',
  'userSetting.changePassword.success': 'Password updated successfully',
  'userSetting.changePassword.error.failed': 'Update failed, please try again',
}
