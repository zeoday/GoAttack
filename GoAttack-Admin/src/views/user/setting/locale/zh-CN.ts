export default {
  ...
  'userSetting.changePassword.oldPassword': '旧密码',
  'userSetting.changePassword.newPassword': '新密码',
  'userSetting.changePassword.confirmPassword': '确认新密码',
  'userSetting.changePassword.placeholder.oldPassword': '请输入旧密码',
  'userSetting.changePassword.placeholder.newPassword': '请输入新密码，至少6位字符',
  'userSetting.changePassword.placeholder.confirmPassword': '请再次输入新密码',
  'userSetting.changePassword.error.oldPassword': '旧密码是必填项',
  'userSetting.changePassword.error.newPassword': '新密码是必填项',
  'userSetting.changePassword.error.passwordLength': '密码长度至少为 6 位',
  'userSetting.changePassword.error.confirmPassword': '确认新密码是必填项',
  'userSetting.changePassword.error.notMatch': '两次输入的密码不一致',
  'userSetting.changePassword.success': '密码修改成功',
  'userSetting.changePassword.error.failed': '修改失败，请重试',
}
